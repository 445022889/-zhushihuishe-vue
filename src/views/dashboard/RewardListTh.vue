<template>
    <div class="page-header-index-wide">
        ...
        <a-card style="padding-top: 0">
            ...
            <a-divider dashed style="margin-top: 0">提货获得记录</a-divider>
            ...
            >
                <a-list-item slot="renderItem" slot-scope="item, index">
                    ...
                    <a-list-item-meta :description="'提货人手机号：'+item.thr"/>
                    <a-list-item-meta :description="'奖金类型：自由提货增值产生'"/>
                    <a-list-item-meta :description="'金豆：'+item.jindou"/>
                    <a-list-item-meta :description="'银豆：'+item.yindou"/>
                </a-list-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                getSign_url: "/Init/index/getRewardth",
